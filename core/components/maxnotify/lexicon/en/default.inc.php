...
$_lang['setting_maxnotify.max_ca_cert_path'] = 'Ministry certificate path';
$_lang['setting_maxnotify.max_ca_cert_path_desc'] = 'Optional absolute path to a PEM file or CA bundle that trusts the Ministry certificate for platform-api2.max.ru.';
